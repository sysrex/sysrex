...
- **[sysrex/opscontainer](https://github.com/sysrex/opscontainer)** - opscontainer for VSCode
...
- [sysrex/gh-notion-sync](https://github.com/sysrex/gh-notion-sync) - Github Issues to Notion Projects Sync (3 months ago)
- [sysrex/posthook](https://github.com/sysrex/posthook) - A small docker image meant to execute posthook curl requests in docker-compose / k8s envs (3 months ago)
- [sysrex/docker-nginx-ip2proxy](https://github.com/sysrex/docker-nginx-ip2proxy) - Docker Nginx Ip2Proxy (3 months ago)
- [celestiaorg/celestia-helm-charts](https://github.com/celestiaorg/celestia-helm-charts) - Celestia Helm Charts (4 months ago)
...
- [celestiaorg/celestia-node @ v0.12.1-rc1](https://github.com/celestiaorg/celestia-node/releases/tag/v0.12.1-rc1) (2 days ago)
- [rollkit/local-celestia-devnet @ v0.12.2](https://github.com/rollkit/local-celestia-devnet/releases/tag/v0.12.2) (5 days ago)
- [celestiaorg/orchestrator-relayer @ v1.0.1](https://github.com/celestiaorg/orchestrator-relayer/releases/tag/v1.0.1) (1 week ago)
- [celestiaorg/terraform-module-scw-k8s @ v0.1.0](https://github.com/celestiaorg/terraform-module-scw-k8s/releases/tag/v0.1.0) (1 month ago)
...
- [[WIP]Sysrex/add snyk integration](https://github.com/celestiaorg/celestia-helm-charts/pull/12) on [celestiaorg/celestia-helm-charts](https://github.com/celestiaorg/celestia-helm-charts) (4 months ago)
- [bump version for node to rc7](https://github.com/celestiaorg/docs/pull/870) on [celestiaorg/docs](https://github.com/celestiaorg/docs) (4 months ago)
- [Sysrex/update docker workflow version](https://github.com/rollkit/local-celestia-devnet/pull/49) on [rollkit/local-celestia-devnet](https://github.com/rollkit/local-celestia-devnet) (4 months ago)
- [chore(nodebuilder/p2p)! Upgrade to mocha-3](https://github.com/celestiaorg/celestia-node/pull/2432) on [celestiaorg/celestia-node](https://github.com/celestiaorg/celestia-node) (5 months ago)
- [feat(nodebuilder): add ip resolving capabilities to core.ip](https://github.com/celestiaorg/celestia-node/pull/2277) on [celestiaorg/celestia-node](https://github.com/celestiaorg/celestia-node) (6 months ago)
...
- **[saml-dev/gome-assistant](https://github.com/saml-dev/gome-assistant)** - A library that lets you write all of your Home Assistant automations in Go! (4 weeks ago)
- **[imba-tjd/rebase-upstream-action](https://github.com/imba-tjd/rebase-upstream-action)** - 🔃 Rebase your fork on upstream. (4 weeks ago)
- **[pulumi/pulumi](https://github.com/pulumi/pulumi)** - Pulumi - Infrastructure as Code in any programming language. Build infrastructure intuitively on any cloud using familiar languages 🚀 (3 months ago)
- **[cmwaters/cheaper-on-celestia](https://github.com/cmwaters/cheaper-on-celestia)** (4 months ago)
- **[anywherelan/awl](https://github.com/anywherelan/awl)** - Securely connect your devices into a private network (5 months ago)

---

#### 📜 My recent blog posts

- [Sending Docker Metrics to Scaleway Cockpit Loki with Prometheus](https://sysrex.com/posts/send-docker-metrics-scaleway/) (9 months ago)
